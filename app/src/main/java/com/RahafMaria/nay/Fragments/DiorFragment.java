...
import com.RahafMaria.nay.Adpaters.DiorAdapter;
...
public class DiorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dior, container, false);
       dior_recyclerView = view.findViewById(R.id.dior_recyclerview);

        diorModels = new ArrayList<>();

        diorAdapter = new DiorAdapter(diorModels);
        dior_recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        fillList();
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                diorAdapter.notifyDataSetChanged();
